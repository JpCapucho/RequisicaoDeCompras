<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="Perfil.aspx.cs" Inherits="RequisicaoAX.Usuario.Perfil" %>
        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Relatório do usuário <small>Relatório de atividade</small></h2>
                        ...
                        <div class="x_content">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                ...
                                <div class="profile_title">
                                    <div class="col-md-6">
                                        <h2>Relatório de atividades do usuário</h2>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                        ...
                                        <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Projetos trabalhados</a>
                                        </li>
